...
def main() -> int:
    ...
    prompt = (
        ...
        f"Specifically check and report on:\n"
        f"  - System & VM rollout health.\n"
        f"  - Submodules & transcription addons (e.g. Whisper/Assist satellite STT and Speaker Diarization / PyAnnote speaker differentiation).\n"
